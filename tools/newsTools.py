...
def startingNewsSearch(topics: list[str]):
    ...
    Returns:
        str: The most relevant news from the web with the topics.
    '''
    tavily_client = TavilyClient(api_key=settings.tavilyApiKey)
    context = []
    for topic in topics:
